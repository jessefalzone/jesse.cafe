...
{{ post_figure(path="treeview-4.png", alt="The completed file tree.",
caption="The completed file tree.") }}

Check out the [working demo](./file-tree.html)! There's no JavaScript, just the
static HTML generated by Vue.
